...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'loan_application_submitted.create': {
    roles: ['business-owner', 'loan-officer', 'accountant', 'administrator'],
    key: 'loan_application',
    tenantPath: [],
    userPath: [],
  },
  'loan_payment_made.update': {
    roles: ['business-owner', 'loan-officer', 'accountant', 'administrator'],
    key: 'loan_payment',
    tenantPath: [],
    userPath: [],
  },
  'loan_application_approved.update': {
    roles: ['business-owner', 'loan-officer', 'accountant', 'administrator'],
    key: 'loan_application',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'loan-officer', 'accountant', 'administrator', 'customer'];
